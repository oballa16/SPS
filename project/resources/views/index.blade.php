                        ...
                        <div class="carousel-content container">
                            <div class="text-c">
                                ...
                                <a data-animation="animated fadeInUp delay-10s" href="/login"
                                   class="btn btn-lg btn-round btn-theme">Already registred? Login</a>
                                <a data-animation="animated fadeInUp delay-10s" href="/register"
                                   class="btn btn-lg btn-round btn-white-lg-outline">Register Now</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-7 offset-lg-1">
                    <div class="managment-slider">
                        <div id="carouselExampleIndicators-managment" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img class="d-block w-100 img-fluid" src="http://placehold.it/540x320"
                                         alt="First slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100 img-fluid" src="http://placehold.it/540x320"
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <div class="row">
                                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                            <div class="avatar">
                                                <img src="http://placehold.it/160x160" alt="avatar-2"
                                ...
                                <div class="carousel-item">
                                    <div class="row">
                                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                            <div class="avatar">
                                                <img src="http://placehold.it/160x160" alt="avatar"
                                                     class="img-fluid rounded">
                                            </div>
                                        </div>
                                        <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                ...
                                <div class="carousel-item">
                                    <div class="row">
                                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                            <div class="avatar">
                                                <img src="http://placehold.it/160x160" alt="avatar-3"
                                                     class="img-fluid rounded">
                                            </div>
                                        </div>
                                        <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12">
                        ...
                        <div class="detail">
                            ...
                            <div class="post-meta clearfix">
                                <ul>
                                    ...
                                    <li class="float-right mr-0"><a href="#"><i class="fa fa-commenting-o"></i></a>15
                                    </li>
