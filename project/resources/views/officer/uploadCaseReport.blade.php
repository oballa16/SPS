    ...
    <div id='mainBanner'>
        ...
        <div class="container-fluid">
            ...
            <ol class="breadcrumb" style="margin-top: 20px">
                ...
                <li class="breadcrumb-item">
                    <a href="{{route('viewCases',['id'=>\Illuminate\Support\Facades\Auth::user()->id])}}">Cases</a></li>
            ...
            <div class="project-sidebar-content">
                ...
                <div class="card">
                    <div class="card-header mb-0">
                        <h4 class="card-title">Case Files Already Uploaded</h4>
                    </div>
                                ...
                                <div class="list-group" style="margin: 20px">
                                    @foreach($case->files as $file)
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <form method="post"
                                                      action="{{route('deleteCaseFile',['id' => $case->id,'fileid' =>$file->id])}}">
                                                    @method('DELETE')
                                                    @csrf
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Upload a file report for task <span
                                    style="color: darkblue">{{$case->title}}</span></h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body" style="text-align: center">
                            <form method="post" action="{{route('uploadCaseFile',['id'=>$case->id])}}"
