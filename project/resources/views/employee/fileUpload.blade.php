                                ...
                                <div class="list-group" style="margin: 20px">
                                    @foreach($files as $file)
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <form method="post"
                                                      action="{{route('deleteFile',['id' => $task->id,'fileid' =>$file->id])}}">
                                                    @method('DELETE')
                                                    @csrf
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Upload a file report for task <span
                                    style="color: darkblue">{{$task->title}}</span></h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body" style="text-align: center">
                            <form method="post" action="{{route('uploadFileReport',['id'=>$task->id])}}"
