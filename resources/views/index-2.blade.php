            ...
            <div class="col-12">
                <nav class="navbar navbar-expand-lg navbar-light rounded">
                    <a class="navbar-brand logo" href="index.html">
                        <img src="{{asset('front')}}/img/logos/black-logo.png" alt="logo">
                    </a>
                        ...
                        <ul class="navbar-nav ml-auto">
                            <li class="nav-item dropdown active">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                    ...
                                    <li><a class="dropdown-item" href="index-2.blade.php">Index 2</a></li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12">
                <img src="{{asset('front')}}/img/logos/logo-white.png" alt="loo">
            </div>
        ...
        <div class="off-canvas-content">
            <aside class="canvas-widget">
                <div class="logo text-center">
                    <img src="{{asset('front')}}/img/logos/logo-white.png" alt="logo">
                </div>
            </aside>
            <aside class="canvas-widget">
                <ul class="menu">
...
<script src="{{asset('front')}}/js/ie-emulation-modes-warning.js"></script>
<!-- Custom JS Script -->
